...
#### Класс Card
Расширяет класс Modal. Предназначен для реализации модального карточки товара.
...
- getProductInfo - метод, который возвращает краткую информацию о товаре (название, описание и цену) для отображения в интерфейсе.
- addToCart - метод для добавления товара в корзину. Устанавливает флаг inCart в true и увеличивает количество товара в корзине, если товар уже был добавлен.
-removeFromCart - метод для удаления товара из корзины. Устанавливает флаг inCart в false и сбрасывает количество до 1.
